            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.child("Users").child(phone).exists())
                {
                    ...
                    if (usersData.getPhone().equals(phone))
                    {
                        ...
                        {
                            Toast.makeText(MainActivity.this, "Te rugam sa astepti...", Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                ...
                {
                    Toast.makeText(MainActivity.this, "Contul cu numarul " + phone + " nu extista.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
